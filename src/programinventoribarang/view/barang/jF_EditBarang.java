...
import programinventoribarang.controller.barang.controller_barangEdit;

/**
 *
 * @author MohamadEsa
 */
public class jF_EditBarang extends javax.swing.JFrame {

    /**
     * Creates new form jF_InputBarang
     */
    String kode, nama, merek, sku, ukuran, satuan;
    ...
    controller_barangEdit barang;
    int mouseX,mouseY;
    public jF_EditBarang() {
        initComponents();
        barang = new controller_barangEdit(this);
//        autoNumber();
    }
...
//    }
    ...
    public void itemTerpilih(){
        jF_KelolaBarang list = new jF_KelolaBarang();
        list.edit = this;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jF_EditBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jF_EditBarang().setVisible(true);
            }
        });
    }
